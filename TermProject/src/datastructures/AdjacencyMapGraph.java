...
public class AdjacencyMapGraph<V,E> implements Graph<V,E> {
    ...
    protected PositionalList<Vertex<V>> vertices = new LinkedPositionalList<>();
    protected PositionalList<Edge<E>> edges = new LinkedPositionalList<>();
    ...
    public Edge<E> insertEdge(Vertex<V> u, Vertex<V> v, E element)
        ...
        if (getEdge(u,v) == null) {
            ...
            throw new IllegalArgumentException("datastructures.Edge from u to v exists");
    }
    ...
    //---------------- nested datastructures.Vertex class ----------------
...
//     sb.append("Edges:");
//     for (datastructures.Edge<E> e : edges) {
//       datastructures.Vertex<V>[] verts = endVertices(e);
//       sb.append(String.format(" (%s->%s, %s)", verts[0].getElement(), verts[1].getElement(), e.getElement()));
//     }
//     sb.append("\n");
        for (Vertex<V> v : vertices) {
            sb.append("datastructures.Vertex " + v.getElement() + "\n");
            if (isDirected)
                sb.append(" [outgoing]");
