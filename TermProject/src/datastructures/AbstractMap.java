...
/**
 * An abstract base class to ease the implementation of the datastructures.Map interface.
 *
...
public abstract class AbstractMap<K,V> implements Map<K,V> {
  ...
  /**
   * A concrete implementation of the datastructures.Entry interface to be used
   * within a datastructures.Map implementation.
   */
  protected static class MapEntry<K,V> implements Entry<K,V> {
    ...
    // public methods of the datastructures.Entry interface
    public K getKey() { return k; }
    public V getValue() { return v; }

    // utilities not exposed as part of the datastructures.Entry interface
